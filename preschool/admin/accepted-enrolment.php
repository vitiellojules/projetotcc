...
<head>
  ...
  <title>Sistema de Matrículas da Pré-Escola | Matrículas Aceitas</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Matrículas Aceitas</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Início</a></li>
              <li class="breadcrumb-item active">Matrículas Aceitas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php 
$query = mysqli_query($con, "SELECT * FROM tblenrollment WHERE (enrollStatus='Accepted')");
$cnt = 1;
...
?>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    <!-- Conteúdo da barra lateral de controle -->
  </aside>
  <!-- /.control-sidebar -->
</div>
<!-- ./wrapper -->
