...
<head>
  ...
  <title>Sistema de Inscrição em Creche | Novas Inscrições</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Novas Inscrições</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Detalhes das Inscrições</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Telefone/Email dos Pais</th>
                    <th>Nome da Criança</th>
                    <th>Faixa Etária da Criança</th>
                    <th>Programa de Inscrição</th>
                    <th>Data de Registro</th>
                    <th>Ação</th>
                  </tr>
                  </thead>
                  <tbody>
<?php $query=mysqli_query($con,"select * from tblenrollment where (enrollStatus is null || enrollStatus='')");
$cnt=1;
