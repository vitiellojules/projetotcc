...
<head>
  ...
  <title>Sistema de Matrícula Creche | Visitantes Não Visitados</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Visitantes Não Visitados</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Início</a></li>
              <li class="breadcrumb-item active">Visitantes Não Visitados</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Detalhes dos Visitantes Não Visitados</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php 
$query = mysqli_query($con, "SELECT * FROM tblvisitor WHERE status='Not-Visited'");
$cnt = 1;
...
?>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    <!-- Conteúdo da barra de controle vai aqui -->
  </aside>
  <!-- /.control-sidebar -->
</div>
<!-- ./wrapper -->
