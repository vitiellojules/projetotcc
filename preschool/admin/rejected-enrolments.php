...
<head>
  ...
  <title>Sistema de Inscrição Creche| Inscrições Rejeitadas</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Inscrições Rejeitadas</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Início</a></li>
              <li class="breadcrumb-item active">Inscrições Rejeitadas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Telefone/E-mail dos Pais</th>
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"select * from tblenrollment where (enrollStatus='Rejected')");
$cnt=1;
