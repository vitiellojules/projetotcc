...
<head>
  ...
  <title>Sistema de Inscrição Creche | Visitantes que Visitaram</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Visitantes que Visitaram</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Visitantes que Visitaram</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"select * from tblvisitor where (status='Visited')");
$cnt=1;
...
?>
                  ...
                  <tr>
                   ...
                   <td><?php echo $result['childName']?></td>
                    ...
                    <th>
     <a href="visitor-details.php?vid=<?php echo $result['id'];?>" title="Ver Detalhes" class="btn btn-primary btn-xm">
       Ver Detalhes</a> 
 </th>
                  </tr>
         <?php $cnt++;} ?>
