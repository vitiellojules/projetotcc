...
$query=mysqli_query($con,"insert into tblvisitor(gurdianName,gurdianEmail,childName,childAge,message,whatsapp,visitTime) 
values('$gname','$emailid','$cname','$cage','$message','$whatsapp','$vtime')");
 ...
 <?php include_once('includes/header.php');?>
        ...
        <div class="container-xxl py-5 page-header position-relative mb-5">
            <div class="container py-5">
                <h1 class="display-2 text-white animated slideInDown mb-4">Agende uma Visita</h1>
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Início</a></li>
                        <li class="breadcrumb-item"><a href="#">Páginas</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Agende uma Visita</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="h-100 d-flex flex-column justify-content-center p-5">
                        <h1 class="mb-4">Agendar uma Visita</h1>
                        <form method="post">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="emailid">Email do Responsável</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-floating">
                                ...
                                <div class="col-sm-6">
                                    <label for="visittime">Horário da Visita</label>
                                </div>                        
